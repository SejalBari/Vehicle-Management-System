...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    ForgetPassword(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("vehiclemanagementsystem/image/forget password.png"));
        Image i2 = i1.getImage().getScaledInstance(175, 175, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(600,70,175,175);
        add(image);
        ...
        search.setBackground(new Color(100,186,188));
