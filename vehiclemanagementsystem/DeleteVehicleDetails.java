...
public class DeleteVehicleDetails extends JFrame implements ActionListener{
    JLabel lblmake, lblmodel, lblyear, lblregnumber,text,lblowner,labelowner,labelmake,labelmodel,labelyear,labelregnumber;
        JButton  back;
        String username;
            
        DeleteVehicleDetails (String username){
        this.username= username;
        setBounds(450, 200, 850, 550);
        setLayout(null);
        getContentPane().setBackground(Color.WHITE);
        
        text = new JLabel("DELETE VEHICLE DETAILS");
        text.setBounds(60,20,400,25);
        ...
        setVisible(true);
         ...
         public void actionPerformed(ActionEvent ae){
              try{
            Conn c = new Conn();
            c.s.executeUpdate("delete from vehicleDetails where username='"+username+"'");
